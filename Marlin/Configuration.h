...
#define STRING_SPLASH_LINE2 "Cuby fix_nivel"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Cuby"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 6400, 185 }
...
#define Z_HOMING_HEIGHT 1  // (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_PROBE_PT_1_Y 175      // of the mesh.
